...
--
-- Table structure for table `asc_positions`
--

DROP TABLE IF EXISTS `asc_positions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `asc_positions` (
...
--
-- Table structure for table `iq32`
--

DROP TABLE IF EXISTS `iq32`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `iq32` (
  ...
  `des_meaning` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `asc_name` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `asc_pseq` int(11) DEFAULT NULL,
  `asc_bseq` int(11) DEFAULT NULL,
  `asc_meaning` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2017-10-30 15:54:47
