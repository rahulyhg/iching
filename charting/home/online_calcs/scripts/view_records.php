...
<script type="text/javascript">
    ...
    function fill(thisValue)
    {
        ...
        if (temp[1] == "undefined") {
            temp[1] = "";
        }   //dont let the ID be called 'undefined'
...
if ($num_records == 1) {
    if ($row['num_recs_to_display'] > 0) {
        $display = $row['num_recs_to_display'];
    }
...
if ($num_records == 0) {
    ...
    echo "<div id='content'>";
    echo "<h1><strong>Welcome, " . $username . ", to your private database</strong></h1>";
    ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="my_sort_by" size="1">
                                ...
                                if ($current_sort_by == "entry_date DESC") {
                                    echo " selected";
                                }
                                ...
                                if ($current_sort_by == "id desc") {
                                    echo " selected";
                                }
                                echo "> ID (descending order)</option>";

                                echo "<option value='month' ";
                                if ($current_sort_by == "month") {
                                    echo " selected";
                                }
                                echo "> Month </option>";
                                ...
                                if ($current_sort_by == "sex") {
                                    echo " selected";
                                }
                                echo "> Sex </option>";

                                echo "<option value='timezone' ";
                                if ($current_sort_by == "timezone") {
                                    echo " selected";
                                }
                                echo "> Time zone </option>";

                                echo "<option value='year' ";
                                if ($current_sort_by == "year") {
                                    echo " selected";
                                }
                                echo "> Year </option>";
                                ?>
    ...
    echo "<br /><a href='get_long_lat_tz.php'>Click here to get a person's longitude, latitude, and time zone information</a><br />";
    echo "<br /><a href='export_data.php'>Click here to display all your data in a format that is importable into Astro123.</a><br />";
    echo "<br /><a href='export_data2.php'>Click here to display all your data in a format that is importable into AstroWin.</a><br />";
    ?>
