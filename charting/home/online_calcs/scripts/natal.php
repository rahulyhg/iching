...
//display natal data
        ...
        ?>
            ...
            <input type="hidden" name="name"        value="<?php echo (isset($_POST['name']) ? $_POST['name'] : NULL); ?>">
            <input type="hidden" name="month"       value="<?php echo (isset($_POST['month']) ? $_POST['month'] : NULL); ?>">
            <input type="hidden" name="day"         value="<?php echo (isset($_POST['day']) ? $_POST['day'] : NULL); ?>">
            <input type="hidden" name="year"        value="<?php echo (isset($_POST['year']) ? $_POST['year'] : NULL); ?>">
            <input type="hidden" name="hour"        value="<?php echo (isset($_POST['hour']) ? $_POST['hour'] : NULL); ?>">
            <input type="hidden" name="minute"      value="<?php echo (isset($_POST['minute']) ? $_POST['minute'] : NULL); ?>">
            <input type="hidden" name="timezone"    value="<?php echo (isset($_POST['timezone']) ? $_POST['timezone'] : NULL); ?>">
            <input type="hidden" name="long_deg"    value="<?php echo (isset($_POST['long_deg']) ? $_POST['long_deg'] : NULL); ?>">
            <input type="hidden" name="long_min"    value="<?php echo (isset($_POST['long_min']) ? $_POST['long_min'] : NULL); ?>">
            <input type="hidden" name="ew"          value="<?php echo (isset($_POST['ew']) ? $_POST['ew'] : NULL); ?>">
            <input type="hidden" name="lat_deg"     value="<?php echo (isset($_POST['lat_deg']) ? $_POST['lat_deg'] : NULL); ?>">
            <input type="hidden" name="lat_min"     value="<?php echo (isset($_POST['lat_min']) ? $_POST['lat_min'] : NULL); ?>">
            <input type="hidden" name="ns"          value="<?php echo (isset($_POST['ns']) ? $_POST['ns'] : NULL); ?>">
...
// no need to urlencode unless perhaps magic quotes is ON (??)
        ...
        $wargs2 = http_build_query($qdata2);

//        print("<PRE>" . var_export($wargs1, TRUE) . "</pre>");
//        print("<PRE>" . var_export($wargs2, TRUE) . "</pre>");


        echo "<center>";
        echo "<img border='0' src='natal_wheel.php?${wargs1}'>";
        echo "<br><br>";
        echo "<img border='0' src='natal_aspect_grid.php?${wargs2}'>";
        echo "</center>";
        echo "<br>";
