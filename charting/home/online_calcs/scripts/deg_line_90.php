...
// create the blank image
  ...
  $overall_size_v = Detect_num_same_deg_planets_max_90($longitude1);
...
//variables
  $x_dist_per_deg = $graphic_width / 90;    //distance is 8 units
  $start_of_y_axis = 5;
...
//shade the fixed sign area from 30 degrees to 60 degrees in gray
  imagefilledrectangle($im, 250, 18, 490, 30, $gray);
...
// load all $longitude1[] into sort[] and keep track of the planet numbers in $sort_pos[]
  ...
  {
    $sort[$i] = Reduce_below_90($longitude1[$i]);
    $sort_pos[$i] = $i;
  }
