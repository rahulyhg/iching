<?php
  ...
  $longitude1 = $_SESSION['prog_syn_p1'];
  $longitude2 = $_SESSION['prog_syn_p2'];
  ...
  $longitude1[LAST_PLANET] = 0;   //no progressed Vertex
...
// put planets in chartwheel - natal person
  ...
  Count_planets_in_each_house($num_planets, $house_pos1, $sort_pos, $sort, $nopih, $home);
