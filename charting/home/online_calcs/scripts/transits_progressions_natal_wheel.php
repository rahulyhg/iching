<?php
  ...
  $longitude1 = $_SESSION['L1'];
  $retrograde1 = $_SESSION['rx1'];
  
  $hc = $_SESSION['hc1'];

  $longitude2 = $_SESSION['L2'];
  $retrograde2 = $_SESSION['rx2'];

  $longitude3 = $_SESSION['L3'];
  $retrograde3 = $_SESSION['rx3'];
  
  $house_pos = $_SESSION['house_pos1'];
  $house_pos2_in_1 = $_SESSION['house_pos2_in_1'];
  $house_pos3_in_1 = $_SESSION['house_pos3_in_1'];
...
// put progressed planets in chartwheel
  // sort longitudes in descending order from 360 down to 0
  ...
  {
    if ($sort_pos[$i] == SE_VERTEX) { continue; }
