<?php
  ...
  $longitude1 = $_SESSION['transits_mp_p1'];
  $longitude2 = $_SESSION['transits_mp_p2'];

  $hc1 = $_SESSION['transits_mp_hc1'];
  $hc2 = $_SESSION['transits_mp_hc2'];

  $house_pos1 = $_SESSION['transits_mp_hp1'];
  $house_pos2_in_1 = $_SESSION['transits_mp_hp2'];
...
// only needed if you want to draw an area outside the outer circle
  imagefilledellipse($im, $center_pt_x, $center_pt_y, $outer_outer_diameter + 40, $outer_outer_diameter + 40, $light_blue);   //max is +40
...
// put planets in chartwheel - transit person
  // sort longitudes in descending order from 360 down to 0
  Sort_planets_by_descending_longitude($num_planets - 4, $longitude2, $sort, $sort_pos);

  // count how many planets are in each house
  Count_planets_in_each_house($num_planets - 4, $house_pos2_in_1, $sort_pos, $sort, $nopih, $home);

  //find the best planet to start displaying the wheel and reorder the $sort[] array starting with that planet
  Find_best_planet_to_start_with($num_planets - 4, $house_pos2_in_1, $sort_pos, $sort, $nopih);
