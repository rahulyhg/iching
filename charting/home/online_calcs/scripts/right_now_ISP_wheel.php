<?php
  ...
  $longitude = $_SESSION['right_now_ISP_p1'];
  $hc = $_SESSION['right_now_ISP_hc1'];
  $house_pos = $_SESSION['right_now_ISP_house_pos1'];
...
// draw in the actual house cusp numbers and sign
  for ($i = 1; $i <= 12; $i = $i + 1)
  {
    ...
    //$int_reduced_pos = sprintf("%.0f", 60 * ($reduced_pos - floor($reduced_pos)));    //if you want rounding
    if ($int_reduced_pos < 10)
    {
      $t = "0" . $int_reduced_pos;
    }
