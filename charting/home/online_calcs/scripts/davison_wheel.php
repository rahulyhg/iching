<?php
  ...
  $longitude = $_SESSION['davison_p1'];
  $hc = $_SESSION['davision_hc1'];
  $house_pos = $_SESSION['davision_house_pos1'];
...
//data for chart
  imagettftext($im, 8, 0, 10, 9, $black, 'arial.ttf', $line1);    //cant go lower than 9 or else the text gets cut off
  imagettftext($im, 8, 0, 10, 27, $black, 'arial.ttf', $line2);
  imagettftext($im, 8, 0, 10, 45, $black, 'arial.ttf', $line3);
