<?php
  ...
  $longitude1 = $_SESSION['syn_longitude_p1'];
  $hc1 = $_SESSION['syn_hc1'];
  $house_pos1 = $_SESSION['syn_house_pos1'];
  
  $longitude2 = $_SESSION['syn_longitude_p2'];
  $hc2 = $_SESSION['syn_hc2'];
  
  $house_pos2_in_1 = $_SESSION['syn_house_pos2_in_1'];
