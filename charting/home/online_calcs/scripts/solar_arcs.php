...
// no need to urlencode unless perhaps magic quotes is ON (??)
    $_SESSION['longitude1_SA'] = $longitude1;
    $_SESSION['hc1_SA'] = $hc1;
    $_SESSION['house_pos1_SA'] = $house_pos1;

    $_SESSION['longitude2_SA'] = $longitude2;
    $_SESSION['hc2_SA'] = $hc2;
    $_SESSION['house_pos2_SA'] = $house_pos2;
    ...
    echo "<center>";
    echo "<img border='0' src='synastry_wheel_2_SA.php?rx1=$rx1&rx2=$rx2&ubt1=$ubt1&ubt2=$ubt2&l1=$line1&l2=$line2' width='$wheel_width' height='$wheel_height'>";
    echo "<br><br>";
    echo "<img border='0' src='sa_aspect_grid.php?rx1=$rx1&rx2=$rx2&ubt1=$ubt1&ubt2=$ubt2' width='830' height='475'>";
    echo "</center>";
    echo "<br>";
...
// display solar arc data - aspect table
    ...
    // update count
    $sql = "SELECT solar_arcs FROM astro_reports";
    $result = @mysqli_query($conn, $sql) or error_log(mysqli_error($conn), 0);
    $row = mysqli_fetch_array($result);
    $count = $row[solar_arcs] + 1;

    $sql = "UPDATE astro_reports SET solar_arcs = '$count'";
    $result = @mysqli_query($conn, $sql) or error_log(mysqli_error($conn), 0);
