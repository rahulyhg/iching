<?php
  ...
  if (isset($_POST['submitted']) Or isset($_POST['h_sys_submitted']))
  {
    ...
    include ('header_lunar_return.html');       //here because of setting cookies above
    ...
    // get all variables from form - lunar return location
...
//    $ns2 = $ns1;
    ...
    if ($start_year != "" And $start_month != "" And $start_day != "")
    {
      ...
      {
        $my_error .= "The lunar return date you entered is not valid.<br />";
      }
    }

    if (($start_month < 1) Or ($start_month > 12))
    {
      $my_error .= "Lunar return date - please enter a month between 1 and 12.<br />";
    }

    if (($start_year < 1200) Or ($start_year >= 2400))
    {
      $my_error .= "Lunar return date - please enter a year between 1200 and 2399.<br />";
    }
...
// lunar return calculations
    ...
    // get next lunar return
      ...
      $start_JD = $start_JD - 1;      // start a little early so we dont miss something close

      // find when Moon is at natal longitudinal position
      $p1_idx = 1;    // Moon index into Swiss ephemeris - for calculating new Moon position
      $Result_JD = Get_when_planet_is_at_certain_degree($n_moon, $p1_idx, $pl_name, $start_JD, $start_JD + 32, $timezone1);
...
//echo $Result_JD . "<br />";
      ...
      //calculate the lunar return Part of Fortune
      //is this a day chart or a night chart?
...
//      echo "</font>";
      ...
      $line2 = $line2 . " - LR on " . strftime("%A, %B %d, %Y at %H:%M (tz = GMT $tz2 hrs)", mktime($the_dt[3], $the_dt[4], $the_dt[5], $the_dt[0], $the_dt[1], $the_dt[2]));
      $line2 = $line2 . " at " . $long_deg2 . $ew2_txt . sprintf("%02d", $long_min2) . " and " . $lat_deg2 . $ns2_txt . sprintf("%02d", $lat_min2);

      $line3 = "Lunar Return on " . strftime("%A, %B %d, %Y at %H:%M (time zone = GMT $tz2 hours)", mktime($the_dt[3], $the_dt[4], $the_dt[5], $the_dt[0], $the_dt[1], $the_dt[2]));
...
<?php
    ...
    $_SESSION['longitude1_LR'] = $longitude1;
    $_SESSION['hc1_LR'] = $hc1;
    $_SESSION['house_pos1_LR'] = $house_pos1;

    $_SESSION['longitude2_LR'] = $longitude2;
    $_SESSION['hc2_LR'] = $hc2;
    $_SESSION['house_pos2_LR'] = $house_pos2;
    
    $_SESSION['house_pos2_in_1_LR'] = $house_pos2_in_1;
    ...
    echo "<center>";
    echo "<img border='0' src='natal_wheel_LR1.php?rx1=$rx1&l1=$line1' width='$wheel_width' height='$wheel_height'>";    //add a planet
    echo "<img border='0' src='natal_wheel_LR2.php?rx1=$rx2&l1=$line2' width='$wheel_width' height='$wheel_height'>";   //add a planet
    echo "<br /><br />";


    echo "<img border='0' src='aspect_grid_lr.php?rx1=$rx2&p0=$L2[0]&p1=$L2[1]&p2=$L2[2]&p3=$L2[3]&p4=$L2[4]&p5=$L2[5]&p6=$L2[6]&p7=$L2[7]&p8=$L2[8]&p9=$L2[9]&p10=$L2[10]&p11=$L2[11]&p12=$L2[12]&p13=$L2[13]&p14=$L2[14]&c1=$hc2[1]&c10=$hc2[10]' width='705' height='450'>";   //add a planet - 2 places
    echo "<br /><br />";
    ...
    echo "<img border='0' src='synastry_wheel_2_LR.php?rx1=$rx1&rx2=$rx2&ubt1=$ubt1&ubt2=$ubt2&l1=$line1&l2=$line3' width='$wheel_width' height='$wheel_height'>";
    echo "<br /><br />";

    echo "<img border='0' src='aspect_grid_natal_and_lr.php?rx1=$rx1&rx2=$rx2&p0=$L1[0]&p1=$L1[1]&p2=$L1[2]&p3=$L1[3]&p4=$L1[4]&p5=$L1[5]&p6=$L1[6]&p7=$L1[7]&p8=$L1[8]&p9=$L1[9]&p10=$L1[10]&p11=$L1[11]&p12=$L1[12]&p13=$L1[13]&p14=$L1[14]&c1=$hc1[1]&c10=$hc1[10]&p0a=$L2[0]&p1a=$L2[1]&p2a=$L2[2]&p3a=$L2[3]&p4a=$L2[4]&p5a=$L2[5]&p6a=$L2[6]&p7a=$L2[7]&p8a=$L2[8]&p9a=$L2[9]&p10a=$L2[10]&p11a=$L2[11]&p12a=$L2[12]&p13a=$L2[13]&p14a=$L2[14]&p15a=$L2[15]&p16a=$L2[16]' width='830' height='475'>"; //add a planet (2 places)
    echo "</center>";
    echo "<br /><br />";


// display lunar return data - aspect table
    ...
    echo '<tr>';
    echo "<td><font color='#0000ff'><b> Lunar Return Planet</b></font></td>";
    ...
    // update count
    $sql = "SELECT lunar_returns FROM astro_reports";
    $result = @mysqli_query($conn, $sql) or error_log(mysqli_error($conn), 0);
    $row = mysqli_fetch_array($result);
    $count = $row[lunar_returns] + 1;

    $sql = "UPDATE astro_reports SET lunar_returns = '$count'";
    $result = @mysqli_query($conn, $sql) or error_log(mysqli_error($conn), 0);
