...
// to make GET string shorter
  ...
  $L1[LAST_PLANET + 1] = $longitude1[LAST_PLANET + 1];
  $L1[LAST_PLANET + 2] = $longitude1[LAST_PLANET + 10];
...
// no need to urlencode unless perhaps magic quotes is ON (??)
    $_SESSION['prog_natal_p1'] = $L1;
    $_SESSION['prog_natal_p2'] = $L2;
    ...
    echo "<center>";
    echo "<img border='0' src='prog_natal_wheel.php?rx1=$rx1&rx2=$rx2&ubt1=$ubt1&ubt2=$ubt2&l1=$line1&l2=$line2' width='$wheel_width' height='$wheel_height'>";
    echo "<br><br>";
    echo "<img border='0' src='prog_natal_aspect_grid.php?rx1=$rx1&rx2=$rx2&ubt1=$ubt1&ubt2=$ubt2' width='830' height='475'>";
    echo "</center>";
    echo "<br>";
...
// display all data - planets
    ...
    echo "<td><font color='#0000ff'><b> Progressed 2 </b></font></td>";
    echo "<td><font color='#0000ff'><b> Longitude </b></font></td>";
    if ($ubt2 == 1)
    {
      echo "<td>&nbsp;</td>";
...
// display progressed planet data - aspect table
    ...
    echo "<td><font color='#0000ff'><b> Natal Planet 1</b></font></td>";
